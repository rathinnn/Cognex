...
class RecommendationsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recommend = channel.unary_unary(
                ...
                request_serializer=recommendations__pb2.FindRequest.SerializeToString,
...
def add_RecommendationsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Recommend': grpc.unary_unary_rpc_method_handler(
                    servicer.Recommend,
                    request_deserializer=recommendations__pb2.FindRequest.FromString,
...
class Recommendations(object):
    ...
    def Recommend(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Recommendations/Recommend',
            recommendations__pb2.FindRequest.SerializeToString,
...
class PutServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Put = channel.unary_unary(
                '/PutService/Put',
                request_serializer=recommendations__pb2.PutRequest.SerializeToString,
                response_deserializer=recommendations__pb2.PutResponse.FromString,
                )
...
def add_PutServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Put': grpc.unary_unary_rpc_method_handler(
                    servicer.Put,
                    request_deserializer=recommendations__pb2.PutRequest.FromString,
                    response_serializer=recommendations__pb2.PutResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class PutService(object):
    ...
    def Put(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/PutService/Put',
            recommendations__pb2.PutRequest.SerializeToString,
            recommendations__pb2.PutResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
